...
Before the next production publish, fix and retest the guest Finish transcript/speech so every guest-facing channel remains honest about linked-only History. Preserve the linked saved-History confirmation only after the completion mutation succeeds. The 2026-07-17 candidate `2686117a` is not release-ready.
