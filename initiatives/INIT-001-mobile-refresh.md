...
| TBD | In progress | `codex/prep-tray-image-fill` | Narrow Prep Tray image-area alignment: ready selected recipe images fill the upper hero panel while pending/placeholder states keep the existing centered slot; no resolver/provider/schema/Ticket Pass behavior changes |
