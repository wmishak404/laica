...
PR #62 merged pantry manual-entry spell correction as `8de1e88`, and PR #63 closed EFF-013 as `12467f8`. PR #64 merged UI-governance enforcement as `e4d5cfe`, and PR #65 closed EFF-015 as `c969fbd`. As of 2026-05-13, the active Effort read list no longer included EFF-013 or EFF-015; Mobile Refresh-adjacent active Effort work was EFF-014 unless the task touched DB/schema workflow EFF-010. EFF-017 remained deferred until the Phase 4 harness pilot.
