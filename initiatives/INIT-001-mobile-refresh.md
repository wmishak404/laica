...
3. Run the reduced Phase 2.1 retest: Test 16 manual delimiter/note/3-ingredient guard, Test 19 placeholder cycling, Test 20 Pantry-to-Kitchen scan-limit separation, Test 21 physical equipment photo acceptance, plus a light spot-check of upload caps and text-only rejection.
