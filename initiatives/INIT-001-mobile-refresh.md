...
**Active PR:** [#184](https://github.com/wmishak404/laica/pull/184) implements Planning toast cleanup but is merge-blocked by a repository-wide `npm-audit` `ws` advisory; [#175](https://github.com/wmishak404/laica/pull/175) merged the Phase 3.1 Ticket Pass hierarchy retry as `6510860` on 2026-06-13.
...
PR #184 implements the next narrow Phase 3.1 Planning polish slice. It removes the extra local/browser-retention explanation from the guest `Your kitchen is ready` setup toast and shortens that confirmation to a 2.5-second title-only toast so it gets out of the way of the Chef It Up / Slop It Up choice cards. It intentionally does not change guest persistence, linked-account promotion, empty-pantry action toasts, Planning card layout, Ticket Pass, Prep Tray, Slop Bowl, or navigation.
...
| Phase 3.1 | In progress | [#69](https://github.com/wmishak404/laica/pull/69), [#73](https://github.com/wmishak404/laica/pull/73), [#75](https://github.com/wmishak404/laica/pull/75), [#81](https://github.com/wmishak404/laica/pull/81), [#141](https://github.com/wmishak404/laica/pull/141), [#175](https://github.com/wmishak404/laica/pull/175), [#184](https://github.com/wmishak404/laica/pull/184); [#78](https://github.com/wmishak404/laica/pull/78) closed unmerged | Kickoff/audit, Planning copy/count emphasis, Slop Bowl pantry-check chip alignment, Setup/Settings inventory review chip states, Slop Bowl generated-result button typography alignment, PR #78 abandonment/retry brief, and accepted Ticket Pass hierarchy retry are merged. PR #184 implements Planning toast cleanup but is merge-blocked by the repository-wide `ws` `npm-audit` advisory. Remaining scope after that branch is light Prep Tray alignment if needed, async imagery, ingredient chip unification, and closeout visual review |
