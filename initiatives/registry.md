...
|---|---|---|---|---|---|---|
| [INIT-001](INIT-001-mobile-refresh.md) | Mobile Refresh | `In Progress` | Wilson / Codex / Claude / Replit | 2026-04-29 | Phase 3.1 follow-up / Phase 4 follow-up | 2026-06-25: `codex/init-001-cooking-step-recovery` opened for inline Live Cooking step-generation recovery and current Finish contract cleanup. |
