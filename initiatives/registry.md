...
| [INIT-003](INIT-003-anonymous-trial-and-account-upgrade.md) | Anonymous Trial and Account Upgrade | `In Progress` | Wilson / Codex / Claude / Replit | 2026-05-15 | Phase 5 / later promotion follow-up planning | None | PR #126 merged the first Phase 4 Google promotion slice as `8282d51` after CI green at `f2eb44d` and Replit validation through code head `2a4ae75`; guest setup preservation is live, completed guest cooks still do not bulk-import into durable History, and any current-cook/History import remains explicit Phase 5 or promotion follow-up scope. |
