...
| [INIT-003](INIT-003-anonymous-trial-and-account-upgrade.md) | Anonymous Trial and Account Upgrade | `In Progress` | Wilson / Codex / Claude / Replit | 2026-05-15 | Production gates implementation — quota, abuse controls, App Check, and linked-account save boundary | [PR #107](https://github.com/wmishak404/laica/pull/107) | `codex/init-003-production-gates` implements local quota, kill switch, anonymous IP rate-limit identity, App Check posture, and linked-only save gates; rebased onto `origin/main` at `fc55772` after PR #108 and local automated checks rerun; Replit schema/runtime validation pending |
