...
|---|---|---|---|---|---|---|---|
| [INIT-001](INIT-001-mobile-refresh.md) | Mobile Refresh | `In Progress` | Wilson / Codex / Claude / Replit | 2026-04-29 | Phase 3.1 / Phase 4 planning | None | Phase 3.1 kickoff/audit is the next default agenda item; EFF-013 and EFF-015 are resolved, EFF-014 remains active scan-review scope, and EFF-017 stays deferred until the Phase 4 harness pilot |
