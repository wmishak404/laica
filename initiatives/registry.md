...
|---|---|---|---|---|---|---|
| [INIT-001](INIT-001-mobile-refresh.md) | Mobile Refresh | `In Progress` | Wilson / Codex / Claude / Replit | 2026-04-29 | Phase 4 follow-up / Phase 3.1 follow-up | 2026-07-09: branch `codex/init-001-assistance-inline-failure` implements the next Phase 4 assistance-failure slice after [#269](https://github.com/wmishak404/laica/pull/269). Live Cooking now keeps the current step visible and shows a warm inline retry panel when `Ask a question` fails from microphone, transcription, usage-limit, empty-answer, or assistance-route issues instead of relying on toast-only or hidden-caption feedback. Local focused Live Cooking Vitest, full unit, check, build, audit, and diff-check pass; exact-head PR/GitHub evidence remains pending. Full provider schema shape and Phase 5 cleanup remain planned. |
