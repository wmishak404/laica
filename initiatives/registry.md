...
|---|---|---|---|---|---|---|
| [INIT-001](INIT-001-mobile-refresh.md) | Mobile Refresh | `In Progress` | Wilson / Codex / Claude / Replit | 2026-04-29 | Phase 4 agentic action planning / Phase 3.1 follow-up | 2026-08-20: Draft Phase 4 agentic cooking actions plan added. `Ask a question` remains the action surface; first proposed slice is confirmed timer action, guarded by typed proposals, risk-tiered confirmation, need-to-act context, fail-closed blocking reports, and a separate `cooking_action_proposal` eval lane before pantry/profile or recipe patching. |
