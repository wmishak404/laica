...
|---|---|---|---|---|---|---|
| [INIT-001](INIT-001-mobile-refresh.md) | Mobile Refresh | `In Progress` | Wilson / Codex / Claude / Replit | 2026-04-29 | Phase 3.1 follow-up / Phase 4 follow-up | 2026-07-06: [#256](https://github.com/wmishak404/laica/pull/256) is the active Phase 4 slice, rejecting blank/placeholder generated or restored Live Cooking steps before Step 1/session start; #236/#234/#237 remain the latest merged INIT-001 runtime slices. |
