...
|---|---|---|---|---|---|---|
| [INIT-001](INIT-001-mobile-refresh.md) | Mobile Refresh | `In Progress` | Wilson / Codex / Claude / Replit | 2026-04-29 | Phase 3.1 follow-up / Phase 4 follow-up | 2026-06-29: [#236](https://github.com/wmishak404/laica/pull/236) merged; inline Live Cooking step-generation recovery is in `main`, with release-batch validation deferred. |
...
| [INIT-004](INIT-004-ai-output-quality-evals.md) | AI Output Quality Evals & Prompt Improvement | `In Progress` | Wilson / Codex / Claude / Replit | 2026-06-09 | Phase 3 - eval harness | 2026-06-23: [#232](https://github.com/wmishak404/laica/pull/232) is active; eval queue/reporting summaries now build on PR #219's separated `chef_it_up_suggestions` surface and prompt-version provenance. |
