...
|---|---|---|---|---|---|---|
| [INIT-001](INIT-001-mobile-refresh.md) | Mobile Refresh | `In Progress` | Wilson / Codex / Claude / Replit | 2026-04-29 | Phase 4 follow-up / Phase 3.1 follow-up | 2026-07-15: [PR #291](https://github.com/wmishak404/laica/pull/291) merged as `766d910`, shipping the setup camera off-state and mobile-browser scroll containment repair. Wilson validated at `6f52420` that the inert/extra setup railing was gone and setup buttons executed expected actions, resolving EFF-031. EFF-028, EFF-029, and EFF-030 remain adjacent visual/setup follow-ups; PR #275 remains the latest merged Phase 4 runtime baseline. |
