...
|---|---|---|---|---|---|---|---|
| [INIT-001](INIT-001-mobile-refresh.md) | Mobile Refresh | `In Progress` | Wilson / Codex / Claude / Replit | 2026-04-29 | Phase 3.1 / Phase 4 planning | `codex/init-001-planning-toast-cleanup` draft PR pending | Branch `codex/init-001-planning-toast-cleanup` implements the next narrow Phase 3.1 slice: guest setup/profile completion now uses a title-only 2.5-second `Your kitchen is ready` toast instead of repeating local/browser-retention copy over the Planning choice cards. |
