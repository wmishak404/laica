...
|---|---|---|---|---|---|---|
| [INIT-001](INIT-001-mobile-refresh.md) | Mobile Refresh | `In Progress` | Wilson / Codex / Claude / Replit | 2026-04-29 | Phase 4 follow-up / Phase 3.1 follow-up | 2026-07-16: [PR #294](https://github.com/wmishak404/laica/pull/294) merged as `4e872dee`, resolving EFF-028 with Chef It Up time-title mobile centering, Ticket Pass heading shortening, and mobile Prep Tray ready-image hero fill. EFF-030 is in progress on `codex/setup-skill-next-action` after Wilson chose select-then-Next for first-time setup cooking skill; EFF-029 remains the next adjacent visual/setup follow-up. |
