...
|---|---|---|---|---|---|---|---|
| [INIT-001](INIT-001-mobile-refresh.md) | Mobile Refresh | `In Progress` | Wilson / Codex / Claude / Replit | 2026-04-29 | Phase 3.1 / Phase 4 planning | None | PR #57 merged the effort-hygiene correction: pantry spell correction and richer scan review stay active standalone Efforts until a specific unclosed Mobile Refresh phase owns them, and future routing should use the INIT phase table/current resume point rather than a phase doc status line alone |
