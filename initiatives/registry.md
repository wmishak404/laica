...
|---|---|---|---|---|---|---|
| [INIT-001](INIT-001-mobile-refresh.md) | Mobile Refresh | `In Progress` | Wilson / Codex / Claude / Replit | 2026-04-29 | Phase 4 follow-up / Phase 3.1 follow-up | 2026-07-07: `codex/init-001-live-cooking-warm-polish` opened from `3d33239` after [#260](https://github.com/wmishak404/laica/pull/260) / #262 closeout to move the compact Live Cooking cockpit onto a warm focus-mode surface, then folded in prompt tightening for plural step-preview labels and final garnish/serve labels after Wilson's Replit examples. Local focused tests, check/build, and provider-light mobile visual/computed-style smoke passed before the prompt commit; GitHub exact-head checks need to rerun. Full timer redesign, full provider schema shape, production/release-batch Replit validation, and Phase 5 cleanup remain planned. |
