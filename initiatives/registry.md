...
|---|---|---|---|---|---|---|
| [INIT-001](INIT-001-mobile-refresh.md) | Mobile Refresh | `In Progress` | Wilson / Codex / Claude / Replit | 2026-04-29 | Phase 4 follow-up / Phase 3.1 follow-up | 2026-07-22: branch `codex/efforts-hygiene-2026-07-22` implements EFF-034 timer Reset -> Start semantics and returning Settings hub blank-tail cleanup from fresh `origin/main` `742694d9`. Exact-head GitHub E2E/review remain pending; EFF-032 stays separate. |
