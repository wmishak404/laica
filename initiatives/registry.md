...
|---|---|---|---|---|---|---|
| [INIT-001](INIT-001-mobile-refresh.md) | Mobile Refresh | `In Progress` | Wilson / Codex / Claude / Replit | 2026-04-29 | Phase 4 follow-up / Phase 3.1 follow-up | 2026-09-11: Agentic Cooking Actions was reclassified as independent INIT-005. INIT-001 remains the shipped Live Cooking baseline but no longer owns or sequences the action platform. |
...
| [INIT-005](INIT-005-agentic-cooking-actions.md) | Agentic Cooking Actions | `Planning` | Wilson / Codex / Claude / Replit | 2026-09-11 | Phase 1 - Action Foundation and Guardrails | 2026-09-11: Wilson reclassified the former INIT-001 Phase 4 extension as an independent seven-phase initiative. Phase 1 establishes the Action Registry, Action Ledger, scoped capability discovery, typed proposals, policy/confirmation gates, blocking reports, and separate action evals before the Phase 2 timer prototype. |
