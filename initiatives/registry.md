...
|---|---|---|---|---|---|---|
| [INIT-001](INIT-001-mobile-refresh.md) | Mobile Refresh | `In Progress` | Wilson / Codex / Claude / Replit | 2026-04-29 | Phase 4 follow-up / Phase 3.1 follow-up | 2026-07-28: PR #344 merged as `31a4806b`, recording Wilson's post-deployment decision to keep the current viewport baseline and defer EFF-035 until Wilson-supplied user feedback or materially changed production evidence. Resume with non-viewport work from fresh `origin/main`; mobile-first validation still applies to unrelated UI changes. |
