...
|---|---|---|---|---|---|---|
| [INIT-001](INIT-001-mobile-refresh.md) | Mobile Refresh | `In Progress` | Wilson / Codex / Claude / Replit | 2026-04-29 | Phase 4 follow-up / Phase 3.1 follow-up | 2026-07-16: [PR #296](https://github.com/wmishak404/laica/pull/296) merged as `fc973996`, resolving EFF-030 with select-then-Next for first-time setup cooking skill. EFF-029 PR #295 now carries first-time setup and returning Settings Pantry/Tools camera/action clearance, Wilson spot-check evidence, and production-readiness registry coverage. |
