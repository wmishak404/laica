...
|---|---|---|---|---|---|---|
| [INIT-001](INIT-001-mobile-refresh.md) | Mobile Refresh | `In Progress` | Wilson / Codex / Claude / Replit | 2026-04-29 | Phase 4 follow-up / Phase 3.1 follow-up | 2026-07-21: PR #324 merged as `af36e8f` from final head `c34380a`, resolving Guest Finish truthfulness and establishing the typed Phase 5 entry contract after EFF-033's PR #325 merge. No production publish or full release-matrix rerun occurred; EFF-032 and EFF-034 remain non-blocking follow-ups. |
