...
|---|---|---|---|---|---|---|---|
| [INIT-001](INIT-001-mobile-refresh.md) | Mobile Refresh | `In Progress` | Wilson / Codex / Claude / Replit | 2026-04-29 | Phase 3.1 / Phase 4 planning | PR #175 / `codex/init-001-ticket-pass-hierarchy` | PR #175 is rebased onto fresh `origin/main` `a20406a` after PR #176 cleared dependency audit and PR #173/#179 landed Settings restore closeout. The Ticket Pass retry remains layout-only with shared pass backing, selected-ticket depth, readable compact rows, and stable in-place selection coverage. Local check/build/audit evidence passes; Replit/manual visual acceptance is pending. |
