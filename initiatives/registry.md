...
| [INIT-004](INIT-004-ai-output-quality-evals.md) | AI Output Quality Evals & Prompt Improvement | `In Progress` | Wilson / Codex / Claude / Replit | 2026-06-09 | Phase 3 - eval harness | `codex/init-004-fixture-validation-script` | Active branch wires public fixture validation into `npm run eval:fixtures` after PR #198. Next Phase 3 candidates after it lands are the next small target-set batch, `pantry_recipes` provenance work, and later calibrated narrow judges. |
