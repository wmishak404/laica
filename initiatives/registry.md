...
| [INIT-003](INIT-003-anonymous-trial-and-account-upgrade.md) | Anonymous Trial and Account Upgrade | `In Progress` | Wilson / Codex / Claude / Replit | 2026-05-15 | Production gates merged; Phase 4/5 follow-up planning | None | PR #107 merged as `a0efc43` after Replit validation at `72ef2f7`: anonymous quota, kill switch, anonymous IP rate-limit identity, App Check enforced smoke, linked-only durable save gates, session-local guest Settings, and guest/linked cache isolation passed. Next scope stays explicit: Phase 4 Google promotion/import, Phase 5 memory/anonymous Slop Bowl decisions, EFF-022 cuisine prompts, EFF-024 guest privacy messaging, and EFF-025 unsaved Settings reminders. |
