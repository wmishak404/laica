...
| [INIT-004](INIT-004-ai-output-quality-evals.md) | AI Output Quality Evals & Prompt Improvement | `In Progress` | Wilson / Codex / Claude / Replit | 2026-06-09 | Phase 3 - eval harness | None | PR #181 merged the accepted Phase 2 spec as `5c410e3` after GitHub checks passed at `d9a17d7`; Phase 3 can start from fresh `origin/main` with the merged rubric/dataset contract, including feature taxonomy, fixture format, public/private storage, cross-user bleed prevention, deterministic guardrails, Wilson-label targets, and EFF-022's cuisine fallback rule still explicitly open. |
