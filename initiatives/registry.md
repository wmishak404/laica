...
| [INIT-003](INIT-003-anonymous-trial-and-account-upgrade.md) | Anonymous Trial and Account Upgrade | `In Progress` | Wilson / Codex / Claude / Replit | 2026-05-15 | Phase 5 / later promotion follow-up planning | None | Checkpoint added: after INIT-001 Phase 5 is implemented/validated, revisit whether any user-consented guest current-cook or selected-cook History import after Google linking should exist. PR #126's first Phase 4 promotion slice remains merged as `8282d51`; no bulk guest History import. |
