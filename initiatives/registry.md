...
| [INIT-004](INIT-004-ai-output-quality-evals.md) | AI Output Quality Evals & Prompt Improvement | `In Progress` | Wilson / Codex / Claude / Replit | 2026-06-09 | Phase 3 - eval harness | None | PR #198 merged as `9588459`: public synthetic cooking-step user-expectation fixtures now protect raw beef doneness, chicken doneness, and missing-lid alternatives. Next Phase 3 candidates are fixture validation scripting, the next small target-set batch, `pantry_recipes` provenance work, and later calibrated narrow judges. |
