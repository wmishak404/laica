...
| [INIT-003](INIT-003-anonymous-trial-and-account-upgrade.md) | Anonymous Trial and Account Upgrade | `Planning` | Wilson / Codex / Claude / Replit | 2026-05-15 | Phase 1 — server auth and abuse-control foundations (next) | None | Phase 0 docs baseline is on `origin/main` at `f3de076`; Phase 1 runtime should start fresh and keep guest auth mode, kill switch, anonymous rate limits, App Check path, and null-safe linked upsert narrow |
