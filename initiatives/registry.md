...
|---|---|---|---|---|---|---|
| [INIT-001](INIT-001-mobile-refresh.md) | Mobile Refresh | `In Progress` | Wilson / Codex / Claude / Replit | 2026-04-29 | Phase 4 agentic action planning / Phase 3.1 follow-up | 2026-08-23: PR #356 merged as `d6300aa6`, publishing the draft Phase 4 agentic cooking actions plan. `Ask a question` remains the action surface; the first proposed implementation slice is confirmed timer action, guarded by typed proposals, risk-tiered confirmation, need-to-act context, fail-closed blocking reports, and a separate `cooking_action_proposal` eval lane before pantry/profile or recipe patching. |
