...
| [INIT-004](INIT-004-ai-output-quality-evals.md) | AI Output Quality Evals & Prompt Improvement | `Planning` | Wilson / Codex / Claude / Replit | 2026-06-09 | Phase 0 - source-of-truth filing and seed-data routing | None | Wilson accepted a standalone INIT for quantitative output-quality evals across recipe recommendations, Slop Bowl, and cooking steps. INIT-004 owns human-labeled rubrics, TPR/TNR-calibrated judge metrics, daily reporting, and prompt-candidate workflow; INIT-002 remains operational error telemetry. |
