...
|---|---|---|---|---|---|---|---|
| [INIT-001](INIT-001-mobile-refresh.md) | Mobile Refresh | `In Progress` | Wilson / Codex / Claude / Replit | 2026-04-29 | Phase 3 implementation | None | Phase 3 Planning/Chef It Up/Ticket Pass/Slop Bowl branch `codex/mobile-refresh-phase-3-planning`; local checks passed, Replit validation pending |
