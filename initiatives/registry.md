...
| [INIT-003](INIT-003-anonymous-trial-and-account-upgrade.md) | Anonymous Trial and Account Upgrade | `In Progress` | Wilson / Codex / Claude / Replit | 2026-05-15 | Post-Phase 3 production gates — quota, abuse controls, App Check, and upgrade-to-save | None | PR #102 merged the Plan B public homepage + clean guest MVP as `515b7ec` after Replit validation at `c952d13`; next work is anonymous quota enforcement, kill switch, rate-limit identity, App Check posture, and upgrade-to-save boundaries |
