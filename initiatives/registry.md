...
| [INIT-004](INIT-004-ai-output-quality-evals.md) | AI Output Quality Evals & Prompt Improvement | `In Progress` | Wilson / Codex / Claude / Replit | 2026-06-09 | Phase 3 - eval harness | [#200](https://github.com/wmishak404/laica/pull/200) / `codex/init-004-fixture-validation-script` | PR #200 wires public fixture validation into `npm run eval:fixtures` after PR #198. Next Phase 3 candidates after it lands are the next small target-set batch, `pantry_recipes` provenance work, and later calibrated narrow judges. |
