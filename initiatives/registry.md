...
|---|---|---|---|---|---|---|
| [INIT-001](INIT-001-mobile-refresh.md) | Mobile Refresh | `In Progress` | Wilson / Codex / Claude / Replit | 2026-04-29 | Phase 4 follow-up / Phase 3.1 follow-up | 2026-07-29: PR #347 merged as `736ee6bd`, resolving EFF-035 after exact-head GitHub gates, direct-shell Replit desktop/mobile validation, and Wilson acceptance. Resume non-viewport work from fresh `origin/main`; the production registry retains the focused setup check for the next publish. |
