...
|---|---|---|---|---|---|---|
| [INIT-001](INIT-001-mobile-refresh.md) | Mobile Refresh | `In Progress` | Wilson / Codex / Claude / Replit | 2026-04-29 | Phase 4 follow-up / Phase 3.1 follow-up | 2026-07-22: PR #333 / `codex/eff-034-timer-settings-cleanup` implements the non-blocking EFF-034 timer Reset -> Start semantics and Settings hub blank-tail cleanup for review from base `742694d9`. No production publish or full release-matrix rerun occurred; EFF-032 remains a subset-phone follow-up. |
