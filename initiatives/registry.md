...
|---|---|---|---|---|---|---|---|
| [INIT-001](INIT-001-mobile-refresh.md) | Mobile Refresh | `In Progress` | Wilson / Codex / Claude / Replit | 2026-04-29 | Phase 3.1 / Phase 4 planning | None | PR #78 was closed unmerged after failing Ticket Pass visual acceptance. Phase 3.1 consistency slices are merged (PR #71 Planning Slop It Up + pantry emphasis; PR #73 Slop Bowl pantry-check chip alignment; PR #75 Setup/Settings inventory chip states; EFF-014 resolved). Next attempt should restart from `main` with a narrower Ticket Pass layout-only brief and keep async imagery separate. |
