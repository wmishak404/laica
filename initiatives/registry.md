...
|---|---|---|---|---|---|---|
| [INIT-001](INIT-001-mobile-refresh.md) | Mobile Refresh | `In Progress` | Wilson / Codex / Claude / Replit | 2026-04-29 | Phase 4 follow-up / Phase 3.1 follow-up | 2026-07-07: `codex/init-001-phase4-timer-polish` opened after [#264](https://github.com/wmishak404/laica/pull/264) / closeout to make existing Live Cooking durations opt-in timer suggestions, clear timer state on step navigation, add a minimizable active timer pill, and suppress timers for obvious prep-only work without changing provider schema. Focused Live Cooking Vitest, check, and build pass locally; exact-head GitHub checks and release/batch Replit validation remain pending/deferred. Full provider schema shape and Phase 5 cleanup remain planned. |
