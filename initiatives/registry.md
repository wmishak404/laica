...
|---|---|---|---|---|---|---|---|
| [INIT-001](INIT-001-mobile-refresh.md) | Mobile Refresh | `In Progress` | Wilson / Codex / Claude / Replit | 2026-04-29 | Phase 3.1 / Phase 4 planning | PR #175 / `codex/init-001-ticket-pass-hierarchy`; PR #173 separately active for Settings/EFF-025 | Codex opened the PR #81 Ticket Pass retry brief from fresh `origin/main` `ca03c3c`: layout-only shared pass backing, selected-ticket depth, readable compact rows, and stable in-place selection coverage. Local checks pass, `npm audit` waits on Dependabot PR #174 for `@grpc/grpc-js`, and authenticated Replit/manual visual acceptance is pending. |
