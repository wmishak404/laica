...
|---|---|---|---|---|---|---|
| [INIT-001](INIT-001-mobile-refresh.md) | Mobile Refresh | `In Progress` | Wilson / Codex / Claude / Replit | 2026-04-29 | Phase 3.1 follow-up / Phase 4 follow-up | 2026-06-29: [#236](https://github.com/wmishak404/laica/pull/236) merged Live Cooking step recovery; [#234](https://github.com/wmishak404/laica/pull/234) merged checked Ticket Pass/Prep Tray ingredient chips; [#237](https://github.com/wmishak404/laica/pull/237) refreshed after #234 and merged Settings unsaved inventory reminders. |
| [INIT-002](INIT-002-ai-error-telemetry.md) | AI Error Telemetry & Eval Monitoring | `In Progress` | Wilson / Codex / Claude / Replit | 2026-05-07 | Phase 2 — Replit observation week | 2026-06-30: Phase 2 observation prep documented missing Replit/runtime evidence and the Wilson decision point before DB/admin telemetry can continue. |
...
| [INIT-004](INIT-004-ai-output-quality-evals.md) | AI Output Quality Evals & Prompt Improvement | `In Progress` | Wilson / Codex / Claude / Replit | 2026-06-09 | Phase 3 - eval harness | 2026-06-29: [#232](https://github.com/wmishak404/laica/pull/232) merged as `5b8e7ed`; eval queue/reporting summaries now use feature and prompt-version grouping with canonical `chef_it_up_suggestions` / `slop_bowl_suggestions` report keys. |
