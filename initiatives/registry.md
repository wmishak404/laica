...
| [INIT-004](INIT-004-ai-output-quality-evals.md) | AI Output Quality Evals & Prompt Improvement | `In Progress` | Wilson / Codex / Claude / Replit | 2026-06-09 | Phase 3 - eval harness | None | PR #219 merged as `68985f1`: eval batches can now separate `/api/recipes/pantry` rows as `pantry_recipes` while retaining reused `recipe_suggestions` prompt-version provenance; no prompt, provider, schema, UI, private-fixture, daily-report, or EFF-022 product-rule change. |
