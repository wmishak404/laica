...
| [INIT-003](INIT-003-anonymous-trial-and-account-upgrade.md) | Anonymous Trial and Account Upgrade | `In Progress` | Wilson / Codex / Claude / Replit | 2026-05-15 | Phase 3 — public pre-auth homepage and client guest entry | None | Plan B on `codex/init-003-preauth-homepage` ships the A+C hybrid public homepage + clean guest MVP before full INIT-001 Phase 4/5; production enablement still waits on Replit auth validation, quota, App Check, abuse controls, and linked-save boundaries |
