...
| [INIT-004](INIT-004-ai-output-quality-evals.md) | AI Output Quality Evals & Prompt Improvement | `In Progress` | Wilson / Codex / Claude / Replit | 2026-06-09 | Phase 3 - eval harness | None | PR #188 merged as `2e1c693`: the offline harness foundation now has eval-vs-prompt feature IDs, public fixture schema/loading, deterministic contract/privacy checks, and cross-user bleed guard. Next Phase 3 work should pick one bounded slice; provider judges, private fixtures, DB migrations, prompt activation, daily reports, and EFF-022 product-rule changes remain out of scope. |
