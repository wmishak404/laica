...
|---|---|---|---|---|---|---|---|
| [INIT-001](INIT-001-mobile-refresh.md) | Mobile Refresh | `In Progress` | Wilson / Codex / Claude / Replit | 2026-04-29 | Phase 3.1 / Phase 4 planning | None | PR #71 merged the first Phase 3.1 Planning-entry runtime slice as `30c7285`: Slop It Up front-door copy plus coral pantry-status emphasis; next narrow Phase 3.1 slice should start from fresh `origin/main` |
