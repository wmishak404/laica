...
| [INIT-004](INIT-004-ai-output-quality-evals.md) | AI Output Quality Evals & Prompt Improvement | `In Progress` | Wilson / Codex / Claude / Replit | 2026-06-09 | Phase 3 - eval harness | 2026-06-22: [#219](https://github.com/wmishak404/laica/pull/219) merged; eval provenance now separates `pantry_recipes` rows without changing prompts/providers/runtime. |
