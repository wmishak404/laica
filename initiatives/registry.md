...
|---|---|---|---|---|---|---|---|
| [INIT-001](INIT-001-mobile-refresh.md) | Mobile Refresh | `In Progress` | Wilson / Codex / Claude / Replit | 2026-04-29 | Phase 3.1 / Phase 4 planning | None | Phase 3.2 shipped through PR #46 (`b22f6b6`, validated at `9646c80`). Phase 3.1 owns design facelift plus recipe imagery and should preserve/restyle the shipped progressive-staple behavior; Phase 4 owns cooking guidance |
