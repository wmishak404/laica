...
|---|---|---|---|---|---|---|
| [INIT-001](INIT-001-mobile-refresh.md) | Mobile Refresh | `In Progress` | Wilson / Codex / Claude / Replit | 2026-04-29 | Phase 4 follow-up / Phase 3.1 follow-up | 2026-07-07: [#258](https://github.com/wmishak404/laica/pull/258) merged as `496731c`, making Live Cooking step generation user-gated behind Ready Check, passing acknowledged optional missing/skipped ingredients into cooking-step generation, and deferring human Replit validation to the release/batch lane. |
