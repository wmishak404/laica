...
| [INIT-005](INIT-005-agentic-cooking-actions.md) | Agentic Cooking Actions | `Planning` | Wilson / Codex / Claude / Replit | 2026-09-11 | Phase 1 - Action Foundation and Guardrails | 2026-09-11: Wilson established the independent seven-phase initiative and clarified that direct, unambiguous timer-start commands need no second confirmation; recipe and durable-data changes do. INIT-005 remains limited to the active cooking task, that user's own data, and approved capabilities. |
