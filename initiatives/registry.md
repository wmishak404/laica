...
| [INIT-004](INIT-004-ai-output-quality-evals.md) | AI Output Quality Evals & Prompt Improvement | `In Progress` | Wilson / Codex / Claude / Replit | 2026-06-09 | Phase 2 - rubric and dataset spec (next) | [#166](https://github.com/wmishak404/laica/pull/166) draft | Phase 1 audit completed from fresh `origin/main` at `c62ad54` after INIT-002 moved to Replit observation. The audit maps current recipe/Slop Bowl/cooking-step surfaces, feature-id gaps, response-shape gaps, privacy/reporting gaps, deterministic checks, and first label-schema direction. Next: Phase 2 taxonomy, fixture format, privacy posture, and Wilson-label target set before harness code. |
