...
|---|---|---|---|---|---|---|
| [INIT-001](INIT-001-mobile-refresh.md) | Mobile Refresh | `In Progress` | Wilson / Codex / Claude / Replit | 2026-04-29 | Phase 4 compact cooking cockpit slice / Phase 3.1 follow-up | 2026-07-07: [#258](https://github.com/wmishak404/laica/pull/258) merged as `496731c`; `codex/init-001-phase4-step-coach` is the current Phase 4 visual/structural slice for single-action Ready Check, sticky current instruction, action-forward step-preview rail, compact cues, opt-in CC captions, taller bottom Repeat/Ask a question/mute controls, screen wake lock, and tokenized loading/recovery continuity, with full timer redesign and Phase 5 cleanup still planned. |
