...
|---|---|---|---|---|---|---|
| [INIT-001](INIT-001-mobile-refresh.md) | Mobile Refresh | `In Progress` | Wilson / Codex / Claude / Replit | 2026-04-29 | Phase 3.1 follow-up / Phase 4 planning | 2026-06-21: [#208](https://github.com/wmishak404/laica/pull/208) merged; Prep Tray selected-image hero fill is the latest Phase 3.1 baseline. |
...
| [INIT-004](INIT-004-ai-output-quality-evals.md) | AI Output Quality Evals & Prompt Improvement | `In Progress` | Wilson / Codex / Claude / Replit | 2026-06-09 | Phase 3 - eval harness | 2026-06-22: [#219](https://github.com/wmishak404/laica/pull/219) merged; eval provenance now separates `pantry_recipes` rows without changing prompts/providers/runtime. Wilson accepted generated-image quality calibration as Phase 7 after the core human-review/reporting workflow exists. |
