...
| [INIT-003](INIT-003-anonymous-trial-and-account-upgrade.md) | Anonymous Trial and Account Upgrade | `In Progress` | Wilson / Codex / Claude / Replit | 2026-05-15 | Production gates merged; Phase 4/5 follow-up planning | None | 2026-06-03 decision: guest promotion uses conversion-gated durability. First Google promotion should preserve user-consented Pantry/Kitchen/Cooking Profile setup work; no bulk/background completed guest-cook History import in the first slice. PR #107 production gates remain merged as `a0efc43` and Replit-validated at `72ef2f7`. |
