...
| [INIT-004](INIT-004-ai-output-quality-evals.md) | AI Output Quality Evals & Prompt Improvement | `In Progress` | Wilson / Codex / Claude / Replit | 2026-06-09 | Phase 3 - eval harness | None | PR #190 merged as `0027908`: first public synthetic fixtures are on `main`, and future tests/evals should use `Value claim`, `Evidence`, and `Evidence limits`. Next fixture batches should add Arize/EFF-022 user-fit cases. |
