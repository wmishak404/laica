...
**Type:** Process
**Scope:** Global
**Applies when:** Deciding whether rationale belongs in a handoff, feature phase record, or top-level PD.
...
- Top-level product decisions capture durable accepted outcomes and the rationale future work should obey or consciously supersede.
