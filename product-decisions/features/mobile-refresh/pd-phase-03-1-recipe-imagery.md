...
- First-time setup pages with a Back/Next rail should not scroll past that rail into inert blank space; the bottom rail is the page end unless a real fixed control requires padding.
