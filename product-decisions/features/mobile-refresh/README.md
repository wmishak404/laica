...
7. Continue Phase 3.1 from fresh `main` for the remaining design facelift plus async recipe imagery. The Planning copy/count, Slop Bowl pantry-check chip alignment, and Setup/Settings inventory review chip-state slices have shipped; remaining work should preserve those decisions while tackling Ticket Pass, Prep Tray, bottom nav fit, closeout visual review, and recipe imagery.
