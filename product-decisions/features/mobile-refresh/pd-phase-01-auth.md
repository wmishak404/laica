...
- Public anonymous entry, the 10-generation guest quota, same-browser guest persistence, and the Google linked-account boundary are now governed by [PD-012](../../pd-012-public-anonymous-trial-and-account-upgrade.md) and [INIT-003](../../../initiatives/INIT-003-anonymous-trial-and-account-upgrade.md).
