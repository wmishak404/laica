...
| Prominence | Equal to manual meal planning | Both paths remain fully accessible |
...
1. Choice screen: "Slop Bowl" or "Plan your own meal" with equal visual weight.
...
5. Cooking: Existing `LiveCooking` flow, with exact instruction handoff clarified during implementation alignment
