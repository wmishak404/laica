...
- Pending runtime branch: `codex/eff-034-timer-settings-cleanup`, implementing the non-blocking timer Reset -> Start label correction and Settings hub blank-tail cleanup from EFF-034.
...
- Branch `codex/eff-034-timer-settings-cleanup` starts from `origin/main` `742694d9d209dba04674ce7188319d7f449c4a6e` and implements the two lower-severity EFF-034 findings preserved from the 2026-07-17 production-readiness run.
