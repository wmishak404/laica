...
- Replit/config evidence: the masked production credential entry is present and currently synchronized to the workspace value. No secret edit, relink, rotation, or republish was performed.
