...
Agents should open the linked mockup asset for the phase they are implementing. The prose is not expected to recreate the visual direction by itself; the annotated exemplars are the anchors.
