...
- On 2026-07-08, the branch was rebased cleanly onto current `origin/main` so exact-head CI evidence can be refreshed without changing scope. It was refreshed again after PR #270 merged into `main`.
