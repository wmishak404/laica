...
- `efforts/effort-012-laica-design-language.md`
  ...
  - Distinguishes EFF-012 from EFF-001: EFF-012 defines the target identity, EFF-001 governs consistent implementation.
  - Marks Phase 2 setup as the first active pilot/correction point.
- `efforts/README.md` and `efforts/registry.md`
  - Added EFF-012 to the active list and registry.
- `product-decisions/features/mobile-refresh/README.md`
  - Linked EFF-012 from the mobile-refresh design principles.
- `product-decisions/features/mobile-refresh/pd-phase-02-setup.md`
  - Added EFF-012 as an explicit Phase 2 interaction.
- `AGENTS.md` and `CLAUDE.md`
  - Added EFF-012 to the current active epic read list for future agent work.

## Impact on other agents

Before implementing or polishing Phase 2-5 mobile-refresh screens, agents should read EFF-012 in addition to EFF-001. PR #23's Phase 2 polish should now treat the setup screens as the first active pilot for LAICA's target design language.
