...
- Added merge signal to EFF-004 and EFF-005.
...
- Continue authenticated smoke automation and workflow-documentation audit work in separate branches under EFF-017 / EFF-020.
