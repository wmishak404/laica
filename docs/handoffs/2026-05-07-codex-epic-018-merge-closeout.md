...
PR #43 merged EFF-018 authenticated AI error handling into `main` as `1110b0088211be593d234ea26392b47384d43470`. This closeout updates the durable docs so future agents see EFF-018 as resolved and continue any follow-up in the right places.
...
- `efforts/README.md`: removed EFF-018 from the active read list.
- `efforts/registry.md`: marked EFF-018 resolved on 2026-05-07 with PR #43 merge signal.
...
EFF-018 no longer needs to be read as an active governance item before ordinary AI error-handling work. Use it as history for the authenticated error contract and copy principles.
