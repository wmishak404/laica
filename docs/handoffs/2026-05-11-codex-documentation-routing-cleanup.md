...
Headline: documentation routing now starts with system consultation and ends with a system-owner closeout summary. The important shift is that agents should explain what changed for future orchestration, not only list the files they touched.

Learning implemented: future closeouts should identify the changed capability, consult the governing docs, choose the smallest durable home, and tell Wilson what system discipline changed, what was validated, and what remains deferred or unvalidated.
...
- Added the orchestrator summary rule so final responses, handoffs, and PR descriptions surface the system-owner headline and the learning implemented for future tasks.
...
- `rg -n "Orchestrator summary|system-owner headline|system-owner summary|Consult Before Filing|Closed Phase Boundary" AGENTS.md CLAUDE.md docs/workflows/documentation-routing.md docs/handoffs/README.md docs/handoffs/2026-05-11-codex-documentation-routing-cleanup.md`
