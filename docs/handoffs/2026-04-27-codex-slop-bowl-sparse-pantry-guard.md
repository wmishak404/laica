...
- `efforts/effort-008-slop-bowl-sparse-pantry-guard.md` — new epic documenting the sparse-pantry failure, accepted product behavior, API semantics, and resolution criteria.
- `efforts/README.md` and `efforts/registry.md` — indexed the Slop Bowl guard plus follow-up Efforts after resolving the numbering collision with `main`.
