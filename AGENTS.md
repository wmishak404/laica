...
- `initiatives/INIT-004-ai-output-quality-evals.md` — read before changing AI output-quality eval rubrics, human review labels, LLM-as-judge calibration, golden datasets, daily eval reports, prompt-candidate workflow, or recipe/Slop Bowl/cooking-step eval criteria.
