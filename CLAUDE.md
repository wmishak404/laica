...
**Orchestrator summary rule.** Final task summaries, handoffs, and PR descriptions should give Wilson a system-owner headline, not just an implementer changelog. State what changed across the product/workflow/docs system, why it matters for orchestration or merge readiness, what learning or discipline was added to future work, what was validated, and what remains deferred or unvalidated. If there is no broader system learning, say that plainly instead of inventing one.
