...
- Manual dispatch passed after GitHub's `VITE_FIREBASE_API_KEY` secret was aligned with the working Firebase Browser key. The earlier failure was no longer an inert workflow or missing authorized-domain issue; it was GitHub secret/Firebase project-key drift.
