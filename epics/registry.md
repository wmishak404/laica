...
| [006](006-equipment-vision-exclusions.md) | Tighten equipment vision prompts to exclude non-kitchen items | `In Progress` | Wilson / Codex / Claude | 2026-04-22 |  | Prompt-first exclusions implemented; awaiting manual image validation |
| [007](007-vision-scan-no-detection-feedback.md) | Vision scan should explicitly say when nothing was detected | `Open` | Wilson / Codex / Claude | 2026-04-27 |  | Filed from live negative-control scan testing; user-facing no-result feedback is inconsistent |
