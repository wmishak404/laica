...
| [018](018-authenticated-ai-error-handling.md) | Authenticated AI error handling and pantry recipe 400s | `Open` | Wilson / Codex / Claude | 2026-05-06 |  | Filed from INIT-001 Phase 3 Replit validation: demo-era AI error toasts/redirects masked pantry recipe 400s |
