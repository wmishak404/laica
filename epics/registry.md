...
| [017](017-environment-parity-and-ci-confidence.md) | Environment parity + CI confidence (reduce manual Replit validation) | `Deferred` | Wilson / Codex / Claude | 2026-05-05 |  | Parked until after INIT-001; preserves parity + CI decision points for later implementation |
| [018](018-authenticated-ai-error-handling.md) | Authenticated AI error handling and pantry recipe 400s | `In Progress` | Wilson / Codex / Claude | 2026-05-06 |  | Implementation branch replaces demo-era AI error toasts/redirects with typed authenticated error classification and first-person copy |
| [019](019-ai-error-telemetry-and-eval-monitoring.md) | AI error telemetry and eval monitoring | `Open` | Wilson / Codex / Claude | 2026-05-07 |  | Filed from EPIC-018 messaging review to design redacted operational AI error telemetry separately from user-facing error UX |
