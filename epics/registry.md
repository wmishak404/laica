...
| [021](021-scan-upload-photo-limit-policy.md) | Scan upload photo limit policy | `Open` | Wilson / Codex / Claude | 2026-05-08 |  | PR #53 merged the runtime cap/concurrency/empty-Pantry guardrail slice as `9aa6c1c`; provider-level multi-image batching and final adaptive chunk thresholds remain open follow-up scope |
