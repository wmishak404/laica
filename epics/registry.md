...
| [021](021-scan-upload-photo-limit-policy.md) | Scan upload photo limit policy | `Open` | Wilson / Codex / Claude | 2026-05-08 |  | Accepted 20-photo per-refresh Pantry/Kitchen policy with 40/day per area, batched/chunked processing direction, scan-specific messaging, empty-Pantry returning-user guardrails, active Settings scan cancellation, and PD-011 as the durable decision record |
