...
| [007](007-vision-scan-no-detection-feedback.md) | Vision scan should explicitly say when nothing was detected | `Open` | Wilson / Codex / Claude | 2026-04-27 |  | Small backlog reminder from equipment-scan validation; some valid empty scans are silent |
...
| [011](011-vision-scan-text-only-safeguard.md) | Vision scans should reject text-only ingredient or equipment screenshots | `Open` | Wilson / Codex / Claude | 2026-04-29 |  | Filed from Phase 2 scan review; text-only screenshots should route to manual entry, not inventory detection |
