...
|---|---|---|---|---|---|---|
| [001](001-ui-governance.md) | UI Consistency & Design Governance | `Open` | Wilson / Codex / Claude | 2026-04-16 |  | Returning Settings computed-style drift exposed scoped-class specificity guardrail |
...
| [012](012-laica-design-language.md) | LAICA Design Language & Visual Identity | `In Progress` | Wilson / Codex / Claude | 2026-04-29 |  | Returning Settings now requires rendered control comparison when reusing setup patterns |
