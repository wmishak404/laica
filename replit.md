...
- **.codex/environments/environment.toml**: Codex local environment config (Node 20.19+, setup commands).
- **.env.example**: Lists all required env var names without values for local agent setup.
- **.nvmrc**: Pins Node.js version to 20.19.0, the minimum Node 20 release supported by Vite 7.
